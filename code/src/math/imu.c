...
{
//	attitude->roll = RADIANS_TO_DEGREES(atan2_approx(rMat[2][1], rMat[2][2])) + 0.1f;
//	attitude->pitch = RADIANS_TO_DEGREES((0.5f * M_PIf) - acos_approx(-rMat[2][0])) - 0.6f;//arcsin = 0.5PI - arccos
